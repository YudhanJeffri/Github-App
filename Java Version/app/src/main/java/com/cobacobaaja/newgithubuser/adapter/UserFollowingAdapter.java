...
public class UserFollowingAdapter extends RecyclerView.Adapter<UserFollowingAdapter.CustomViewHolder>  {
    ...
    public UserFollowingAdapter(Context context, List<User> dataList){
