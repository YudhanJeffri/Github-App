package com.cobacobaaja.newgithubuser.adapter;
...
public class UserFollowerAdapter extends RecyclerView.Adapter<UserFollowerAdapter.CustomViewHolder> {

    private static List<User> dataList;
    private Context context;

    public static List<User> getTasks() {
        return dataList;
    }
    ...
    public UserFollowerAdapter(Context context, List<User> dataList){
